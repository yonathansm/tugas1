...
$st = new IDNstemmer();
$konek = mysqli_connect("localhost","u347329180_yona","yonathansm","u347329180_stbi");
...
//$st->doStemming($filteredarray)
	   //echo " ".$hasil.'<br>';
	   $query = "INSERT INTO dokumen (namafile, token, tokenstem, tokenstem2)  
...
if (move_uploaded_file($lokasi_file,"$folder")){
  ...
  $konek = mysqli_connect("localhost","u347329180_than","yonathansm","upload");
